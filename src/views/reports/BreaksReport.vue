<template>
  <div class="report-breaks row bg-white flex-column align-items-center pb-4">
...
export default {
  ...
  methods: {
    ...mapActions(["loadShiftTypes", "getBreaksReport"]),
    generateReport() {
      console.log("generar reporte");
      if (!this.validate()) {
        return;
      }
      this.getBreaksReport({
