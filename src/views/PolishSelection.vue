<template>
  <div class="row bg-white color-selection">
    <h4 class="col-12 text-center form-title">Ingresar código del pulidor</h4>
    <div class="form-container row w-100">
      <div class="col-5 text-center d-flex flex-column">
        <h4 class="w-100">Ingrese el código del pulidor</h4>
...
export default {
  ...
  methods: {
    ...mapActions(["loadOperators", "selectPolishOperator"]),
    onSubmit() {
      if (this.validate()) {
        this.selectPolishOperator(this.prefix + this.operatorCode);
